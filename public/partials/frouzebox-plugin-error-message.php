...
<div class="error-message">
  <h2><?php _e('Il y a une erreur','frouzebox-forms');?></h2>
  <a href="<?php echo site_url(); ?>" target="_self" data-hover-background-color="#ff9f1f" data-hover-border-color="#fff" data-hover-color="#fff" class="qbutton  small right default" style="color: rgb(255, 255, 255); border-color: rgb(255, 159, 31); font-style: normal; font-weight: 400; font-family: Rubik; text-transform: none; font-size: 15px; letter-spacing: 0.2px; background-color: rgb(255, 159, 31);" rel="noopener noreferrer">
  <?php _e("Aller à la page d'accueil",'frouzebox-forms');?> <i class="qode_icon_font_awesome fa fa-sign-in qode_button_icon_element" style="color: #fff;"></i>
  </a>
</div>
